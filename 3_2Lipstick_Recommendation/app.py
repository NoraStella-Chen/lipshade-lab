...
def process_uploaded_image():
    uploaded_file = st.file_uploader(
        "Choose an image to identify your skin tone",
        type=['png', 'jpg', 'jpeg']
    )
...
with col1:
    ...
    if identification_method == "Upload Image":
    ...
    if tab == "Expert Recommendations":
        if identification_method == "Upload Image" and detected_expert_tone:
        ...
        if identification_method == "Upload Image" and detected_sephora_tone:
